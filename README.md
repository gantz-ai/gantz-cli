...
- **Local Mode**: Run without tunneling for development/testing
...
Download the latest release for your platform from [Releases](https://github.com/gantz-ai/gantz-cli/releases).

```bash
# macOS (Apple Silicon)
curl -L https://github.com/gantz-ai/gantz-cli/releases/latest/download/gantz-darwin-arm64 -o gantz
chmod +x gantz
sudo mv gantz /usr/local/bin/

# macOS (Intel)
curl -L https://github.com/gantz-ai/gantz-cli/releases/latest/download/gantz-darwin-amd64 -o gantz
chmod +x gantz
sudo mv gantz /usr/local/bin/

# Linux (x64)
curl -L https://github.com/gantz-ai/gantz-cli/releases/latest/download/gantz-linux-amd64 -o gantz
chmod +x gantz
sudo mv gantz /usr/local/bin/
```
...
| `--local` | | `false` | Local only mode (no tunnel) |
...
gantz serve --relay wss://my-relay.example.com
```
...
1. Start the relay server locally:
   ```bash
   cd ../gantz-relay && make run-dev
   ```

2. Run gantz-cli with local relay:
   ```bash
   gantz serve --relay ws://localhost:8081/tunnel --local
   ```
...
- [gantz-relay](https://github.com/gantz-ai/gantz-relay) - Tunnel relay server
- [gantz-portal](https://github.com/gantz-ai/gantz-portal) - Web platform for API-to-MCP conversion
- [gantz-server](https://github.com/gantz-ai/gantz-server) - Portal backend API

## License

Copyright 2024 Gantz AI. All rights reserved.
